...
export const HEALTHY_PAYABLES: PayableAccount[] = [
  ...
  {
    id: 'pay-h-004',
    description: 'Salario colaborador ',
    amount: 4500,
  ...
  // ── Parcelamento: Equipamento Industrial ──
  {
    id: 'pay-h-inst-001',
    description: 'Forno Industrial',
    amount: 2250,
    dueDate: daysFromNow(3),
    categoryId: CAT_IDS.fornecedores,
    status: 'PENDENTE',
    recurrence: 'INSTALLMENT',
    installmentGroupId: 'ig-forno-001',
    installmentNumber: 1,
    totalInstallments: 4,
  },
  {
...
export const RISK_MOVEMENTS: Movement[] = [
  { id: 'mov-r-001', type: 'ENTRADA', amount: 6500, date: daysAgo(28), categoryId: CAT_IDS.receitas, description: 'Servicos' },
  { id: 'mov-r-002', type: 'ENTRADA', amount: 4800, date: daysAgo(21), categoryId: CAT_IDS.receitas, description: 'Servicos' },
  { id: 'mov-r-003', type: 'ENTRADA', amount: 3200, date: daysAgo(14), categoryId: CAT_IDS.receitas, description: 'Servicos' },
  { id: 'mov-r-004', type: 'ENTRADA', amount: 1900, date: daysAgo(5), categoryId: CAT_IDS.receitas, description: 'Servicos avulsos' },
  { id: 'mov-r-005', type: 'SAIDA', amount: 2800, date: daysAgo(26), categoryId: CAT_IDS.aluguel, description: 'Aluguel' },
  { id: 'mov-r-006', type: 'SAIDA', amount: 4500, date: daysAgo(19), categoryId: CAT_IDS.salarios, description: 'Salario colaborador' },
  { id: 'mov-r-007', type: 'SAIDA', amount: 1800, date: daysAgo(12), categoryId: CAT_IDS.energia, description: 'Conta de energia' },
  { id: 'mov-r-008', type: 'SAIDA', amount: 1200, date: daysAgo(8), categoryId: CAT_IDS.impostos, description: 'DAS Simples Nacional' },
...
export const HEALTHY_RECEIVABLES: ReceivableAccount[] = [
  ...
  // ── Parcelamento: Projeto Beta ──
  {
    ...
    status: 'PENDENTE',
    recurrence: 'INSTALLMENT',
    installmentGroupId: 'ig-beta-001',
    installmentNumber: 1,
    totalInstallments: 3,
  },
  {
